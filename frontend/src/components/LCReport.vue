  ...
  return {
    ...
    items: {
      Quartile_weekly: {
        ...
        data_status:       r.items?.Quartile_weekly?.data_status     ?? null,
        data_status_label: r.items?.Quartile_weekly?.data_status_label ?? '',
      },
      SalesRptByProduct: {
        ...
        data_status:       r.items?.SalesRptByProduct?.data_status     ?? null,
        data_status_label: r.items?.SalesRptByProduct?.data_status_label ?? '',
      },
      FundAnalysis: {
        ...
        data_status:       r.items?.FundAnalysis?.data_status     ?? null,
        data_status_label: r.items?.FundAnalysis?.data_status_label ?? '',
      },
    },
  }
}
